...
<div class="warning" id="resetProbeWarning" hidden><strong data-i18n="resetProbe.warningTitle">自动激活新的额度周期默认关闭</strong><span data-i18n="resetProbe.warningBody">开启后，调度器会按额度刷新间隔（最短 30 分钟）在后台只读检查额度；只有发现延迟启动的重置窗口时，才发送一次极小的 Codex 请求。</span></div>
