...
const INLINE_TRANSLATIONS=[
  ...
  ['缓存时间','Cache age'],['额度来源','Quota source'],['响应观测','Response observation'],['轮询刷新','Polled refresh'],['熔断计数','Circuit counts'],['失败','Failures'],['成功','Successes'],['主动重置','Reset credits'],['调度状态','Scheduler state'],[' 次',' times'],['累计','total'],['有效期','expires'],
